...
var AgentNetwork = class extends chunk73LEILKH_cjs.MastraBase {
  #instructions;
  #agents;
  #model;
  #routingAgent;
  #agentHistory = {};
  constructor(config) {
    super({ component: chunkZIZ3CVHN_cjs.RegisteredLogger.NETWORK, name: config.name || "AgentNetwork" });
    this.#instructions = config.instructions;
    this.#agents = config.agents;
    this.#model = config.model;
    this.#routingAgent = new chunkZHBAIO3U_cjs.Agent({
      name: config.name,
