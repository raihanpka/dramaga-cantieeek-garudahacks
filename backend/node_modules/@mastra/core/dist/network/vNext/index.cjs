...
var NewAgentNetwork = class extends chunk73LEILKH_cjs.MastraBase {
  id;
  name;
  #instructions;
  #model;
  ...
  async getRoutingAgent({ runtimeContext }) {
    ...
    const instructions = `
        ...
        `;
    return new chunkZHBAIO3U_cjs.Agent({
      name: "routing-agent",
      instructions,
      model: this.#model,
      memory: memoryToUse,
  ...
  async loop(message, {
    ...
    const finalStep = chunk2D4F4EBF_cjs.createStep({
      id: "final-step",
    ...
    const mainWorkflow = chunk2D4F4EBF_cjs.createWorkflow({
  ...
  createWorkflow({ runtimeContext }) {
    ...
    const routingStep = chunk2D4F4EBF_cjs.createStep({
      id: "routing-step",
      inputSchema: zod.z.object({
        task: zod.z.string(),
        resourceId: zod.z.string(),
...
${completionResult.object.finalResult}` : ""}
    ...
    const agentStep = chunk2D4F4EBF_cjs.createStep({
      id: "agent-step",
      inputSchema: zod.z.object({
        task: zod.z.string(),
        resourceId: zod.z.string(),
    ...
    const workflowStep = chunk2D4F4EBF_cjs.createStep({
      id: "workflow-step",
      inputSchema: zod.z.object({
        task: zod.z.string(),
        resourceId: zod.z.string(),
    ...
    const toolStep = chunk2D4F4EBF_cjs.createStep({
      id: "toolStep",
      inputSchema: zod.z.object({
        task: zod.z.string(),
        resourceId: zod.z.string(),
    ...
    const finishStep = chunk2D4F4EBF_cjs.createStep({
      id: "finish-step",
      inputSchema: zod.z.object({
        task: zod.z.string(),
        resourceId: zod.z.string(),
    ...
    const networkWorkflow = chunk2D4F4EBF_cjs.createWorkflow({
