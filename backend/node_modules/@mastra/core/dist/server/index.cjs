...
_MastraAuthProvider_decorators = [chunkO3YMKNEP_cjs.InstrumentClass({
  prefix: "auth",
  excludeMethods: ["__setTools", "__setLogger", "__setTelemetry", "#log"]
})];
exports.MastraAuthProvider = class MastraAuthProvider extends (_a = chunk73LEILKH_cjs.MastraBase) {
  constructor(options) {
    super({
      component: "AUTH",
      name: options?.name
