...
var chunkAFVFQE25_cjs = require('../chunk-AFVFQE25.cjs');
...
var LegacyEvalsStorage = class extends chunk73LEILKH_cjs.MastraBase {
  constructor() {
    super({
      component: "STORAGE",
      name: "LEGACY_EVALS"
...
var MemoryStorage = class extends chunk73LEILKH_cjs.MastraBase {
  constructor() {
    super({
      component: "STORAGE",
      name: "MEMORY"
...
var InMemoryMemory = class extends MemoryStorage {
  ...
  async saveMessages(args) {
    ...
    const list = new chunkF4BRBWD2_cjs.MessageList().add(messages, "memory");
...
var StoreOperations = class extends chunk73LEILKH_cjs.MastraBase {
  constructor() {
    super({
      component: "STORAGE",
      name: "OPERATIONS"
...
var StoreOperationsInMemory = class extends StoreOperations {
  ...
  async insert({ tableName, record }) {
    ...
    let key = record.id;
    if ([chunkLHCCHHNV_cjs.TABLE_WORKFLOW_SNAPSHOT, chunkLHCCHHNV_cjs.TABLE_EVALS].includes(tableName) && !record.id && record.run_id) {
      key = record.run_id;
      record.id = key;
    } else if (!record.id) {
...
var ScoresStorage = class extends chunk73LEILKH_cjs.MastraBase {
  constructor() {
    super({
      component: "STORAGE",
      name: "SCORES"
...
var TracesStorage = class extends chunk73LEILKH_cjs.MastraBase {
  constructor() {
    super({
      component: "STORAGE",
      name: "TRACES"
...
var WorkflowsStorage = class extends chunk73LEILKH_cjs.MastraBase {
  constructor() {
    super({
      component: "STORAGE",
      name: "WORKFLOWS"
...
// src/storage/mock.ts
var InMemoryStore = class extends chunkAFVFQE25_cjs.MastraStorage {
  stores;
  constructor() {
...
Object.defineProperty(exports, "MastraStorage", {
  enumerable: true,
  get: function () { return chunkAFVFQE25_cjs.MastraStorage; }
});
Object.defineProperty(exports, "ensureDate", {
  enumerable: true,
  get: function () { return chunkAFVFQE25_cjs.ensureDate; }
});
Object.defineProperty(exports, "resolveMessageLimit", {
  enumerable: true,
  get: function () { return chunkAFVFQE25_cjs.resolveMessageLimit; }
});
Object.defineProperty(exports, "serializeDate", {
  enumerable: true,
  get: function () { return chunkAFVFQE25_cjs.serializeDate; }
});
Object.defineProperty(exports, "SCORERS_SCHEMA", {
  enumerable: true,
  get: function () { return chunkLHCCHHNV_cjs.SCORERS_SCHEMA; }
});
Object.defineProperty(exports, "TABLE_EVALS", {
  enumerable: true,
  get: function () { return chunkLHCCHHNV_cjs.TABLE_EVALS; }
});
Object.defineProperty(exports, "TABLE_MESSAGES", {
  enumerable: true,
  get: function () { return chunkLHCCHHNV_cjs.TABLE_MESSAGES; }
});
Object.defineProperty(exports, "TABLE_RESOURCES", {
  enumerable: true,
  get: function () { return chunkLHCCHHNV_cjs.TABLE_RESOURCES; }
});
Object.defineProperty(exports, "TABLE_SCHEMAS", {
  enumerable: true,
  get: function () { return chunkLHCCHHNV_cjs.TABLE_SCHEMAS; }
});
Object.defineProperty(exports, "TABLE_SCORERS", {
  enumerable: true,
  get: function () { return chunkLHCCHHNV_cjs.TABLE_SCORERS; }
});
Object.defineProperty(exports, "TABLE_THREADS", {
  enumerable: true,
  get: function () { return chunkLHCCHHNV_cjs.TABLE_THREADS; }
});
Object.defineProperty(exports, "TABLE_TRACES", {
  enumerable: true,
  get: function () { return chunkLHCCHHNV_cjs.TABLE_TRACES; }
});
Object.defineProperty(exports, "TABLE_WORKFLOW_SNAPSHOT", {
  enumerable: true,
  get: function () { return chunkLHCCHHNV_cjs.TABLE_WORKFLOW_SNAPSHOT; }
});
